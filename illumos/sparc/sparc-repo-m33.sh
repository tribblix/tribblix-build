...
#
# this script reproduces the m33 sparc repo
#
# this is the same as m32, but the build will pull in some extra patches
#
...
gatepatch 449d1bccce5a4198daba9242938ca739c57dcf21
# 16385 rpcmod: should use kstat x_ksp->ks_lock
gatepatch 6f914afdc10e2ab6ea408f51db33c53ff977b382
# 14097 time to disable SMB1 by default
gatepatch 92101ea43dccf9afc9af34c02a30de381d3fe66a
# 15505 convert cstyle.ms to mdoc
gatepatch 14c37bbde52123f82ce13cc76dcb4271a0867735
# 16225 cputrack should not be isaexec'd
gatepatch 12fb9219923f41528f673d4f31667db2c3f103ff
...
gatepatch 8efd981e8468a29f137fe78d8fe4a739aa206fb0
# 16451 bofi(4D) has weird and meaningless file permissions
gatepatch 4f19760d7d174b081e8d9b19fe49c32da7513f8a
# 16458 genunix: memory leak in ip_helper_stream.c
gatepatch c186a8535e0daf2837f022eb42b70fc5281ca2b9
# 16464 Typo in i40e(4D)
gatepatch 0e23ca977e50bb6298f4183fbbdcfe6bc8f2e447
# 16459 want emlxs to support Oracle branded LP adapters
gatepatch aba38c6376bdf0b551d8117ead52114b29d64c6d
# 16495 ptree -g should be more willing to use UTF-8 box characters
gatepatch 21ca3fa0977dd3ad21d619522ac5e57d35b022b1
# 16498 closed nfs dmod/kmod are still delivered
gatepatch eac40bb3773af39d290bd832c86fb016aa367ca4
# 16508 snoop incorrectly prints the IPv6 Traffic Class
gatepatch f386ca6eb95437e65247ad9cc1765e0b3c6c1244
# 16528 clean up low-hanging warnings in svccfg(8)
gatepatch b960b5ef739d69365f28458932126c08e93ffe7e
# 16350 SHA1 may produce incorrect hashes if given a 2^29 byte input
gatepatch 4e0cc57d7ff13862aa2a3b1eed78c72355eda972
# 16529 TIOCGWINSZ returns EINVAL on a freshly-created pty
gatepatch 3ade83088bf2797d3800b650040b7ea6f9fc7c14
# 16542 Document ACL_NORESOLVE flag for acl_totext
gatepatch 4d8d108f42a089b7b4441353f2ad7a75e1c7b31d
# 16528 clean up low-hanging warnings in svccfg(8) (duplicate definition)
gatepatch ee073065c7200b026f498d9cad2beb87ba3b57a7
# 16492 ipkg brand should include smbsrv1 device
gatepatch d5b563f27eb78296f57dddced6755afe7445c4b9
# 16517 Overhaul section 9 intro pages
gatepatch f17620a4f72a29025a22655ba8735ccd20ae174f
# 16530 cmd/audio should deal in big-endian and little-endian, not sparc and i386
gatepatch 3b363e384673bd88fc57814d909651859c7c41a3
# 16657 fnmatch(3c) typos FNM_CASEFOLD as FNM_FOLDCASE
gatepatch 63f43743ab6adab27e85445338126bee08911ca9
# 16659 Clean up minor issues in prototype.man3x
gatepatch aed162cfceb2959d973ec638d3d3cf5a730e3a03
# 14252 Adjust boolean_t under __EXTENSIONS__
gatepatch eb96f8f799ef5344a5736dd0f1721bc2ee59f980
# 16703 types.h.3head has incorrect type for LP64 ino_t
gatepatch 5e302d10a5edb261c2788efeac96e18a97a33d08
# 15289 cmd: remove pragma ident
# this edits a lot of files so is a prereq for other changes
gatepatch 2a8bcb4efb45d99ac41c94a75c396b362c414f7f
# 16798 /bin/false should not exit with 255
gatepatch 2833423dc59f4c35fe4713dbb942950c82df0437

# added for m32
# 15290 lib: remove pragma ident
# this edits a lot of files so is a prereq for other changes
gatepatch 1da57d551424de5a9d469760be7c4b4d4f10a755
# 15622 topo_mod_dprintf badly needs warnings
# causes the build to fail
#gatepatch 6597d6fcfd3058014e6518bb93c97eb0a42b4c3e
# 15646 fm ses code could use additional formatting handholding
#gatepatch 87cd64a11587dea20bafe125d7f26ca6e4b1a0e0
# 15181 Add errc, verrc, warnc, vwarnc to libc
gatepatch 621b6cf75a027e4c06f2a1b3207abb5f24539b14
# 14484 Update Intel microcode to 20220207
gatepatch 74e98f497ae878ae481ccba1f91fd8dc26fa6627
# 14741 Update Intel Microcode to 20220510
gatepatch ec6a85f5d3beb28d36eda5ef325b7410d7f3cfa3
# 14848 Update AMD microcode to 202204
gatepatch be672c8e21cc446e1091014ae0ad206f6b8c1d55
# 14295 Allow shipping an additional libbe_py
gatepatch 45ede40b2394db7967e59f19288fae9b62efd4aa
# 14583 developer/opensolaris/osnet requirements cleanup
gatepatch a677d6730e287aadab3cc68d0c46fb01b25d72eb
# 13896 bhyve VM interfaces should be better fit
gatepatch 0153d828c132fdb1a17c11b99386a3d1b87994cf

# TODO
# 15219 6d3b960aa395b3d268922a1938aed248a213725b
# 16100 66c260c2dc9aa3abc53a820780d40a31b978ff0e
# 16197 6cf3cc9d1e40f89e90135a48f74f03f879fce639

#failed
#a7bf1903fa865f16057324ac0561c011bff86eee
#f2ae17ede4a9a93585872a9aa83120497285bdd0
#8779b44894428ca4ea78d1bfe5381291f62e9c7d
#ed093b41a93e8563e6e1e5dae0768dda2a7bcc27
