...
#
# Now ensure we have a working SMF repository. We try and copy in a prebuilt
# repository to avoid the cost of import at first boot. We have custom ones
# preconfigured for the kitchen-sink and x11 overlays that force services
# like slim and hal to be enabled.
#
